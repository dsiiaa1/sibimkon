...
export default function DashboardShell({
  ...
  return (
    <div className="flex min-h-screen w-full max-w-[100vw] overflow-x-hidden" style={{background: 'var(--background)', color: 'var(--text-primary)'}}>
      ...
      <div className={`flex-1 flex flex-col w-full min-w-0 min-h-screen transition-[padding] duration-300 ease-in-out ${isCollapsed ? 'md:pl-20' : 'md:pl-72'}`} style={{background: 'var(--color-bg-base)'}}>
        {/* Header bar */}
