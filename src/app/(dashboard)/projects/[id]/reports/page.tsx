          ...
          <div className="glass-card rounded-3xl border border-slate-800 bg-slate-950/20 p-6 md:p-8 space-y-4">
            ...
            <div className="grid grid-cols-3 gap-2 bg-slate-950 border border-slate-850 p-4 rounded-2xl">
              <div className="text-center">
                ...
                <span className="text-lg font-bold text-slate-400">{beforeScore > 0 ? `${beforeScore}%` : '—'}</span>
                <span className="text-[9px] text-slate-600 block">analisis charter</span>
              </div>
              <div className="text-center border-x border-slate-850">
                ...
                <span className="text-lg font-bold text-indigo-400">{afterScore > 0 ? `${afterScore}%` : '—'}</span>
                <span className="text-[9px] text-slate-600 block">setelah improvement</span>
              </div>
              <div className="text-center">
                <span className="text-[10px] text-slate-500 uppercase tracking-wider block">Peningkatan</span>
                <span className={`text-lg font-bold ${improvement > 0 ? 'text-emerald-400' : 'text-slate-600'}`}>
                  {improvement > 0 ? `+${improvement}%` : '—'}
                </span>
                <span className="text-[9px] text-slate-600 block">skor produktivitas</span>
              </div>
            </div>
